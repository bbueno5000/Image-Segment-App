package com.example.imagesegmentation.utils
...
abstract class ImageUtils {
    ...
    companion object {
        ...
        fun bitmapToByteBuffer(
            bitmapIn: Bitmap, width: Int, height: Int, mean: Float = 0.0f,
            std: Float = 255.0f): ByteBuffer {
            ...
            for (y in 0 until height) {
                for (x in 0 until width) {
                    ...
                    // This requirement varies by model.
                    // For example, some models might require values to be normalized
        ...
        fun scaleBitmapAndKeepRatio(
            targetBmp: Bitmap, reqHeightInPixels: Int, reqWidthInPixels: Int): Bitmap {
